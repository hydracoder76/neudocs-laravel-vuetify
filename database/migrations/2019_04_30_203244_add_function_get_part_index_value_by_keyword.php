...
class AddFunctionGetPartIndexValueByKeyword extends Migration
{
    /**
     * Run the migrations.
     *
...
BEGIN
        ...
        create temp table temp_distinct_part_indexes as select part_index_value from temp_part_indexes group by part_index_value limit p_limit;
        drop table temp_part_indexes;
        return query SELECT * FROM temp_distinct_part_indexes;
        drop table temp_distinct_part_indexes;
END;
$$    
SQL;
