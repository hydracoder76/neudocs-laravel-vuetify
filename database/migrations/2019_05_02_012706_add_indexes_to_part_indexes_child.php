...
class AddIndexesToPartIndexesChild extends Migration
{
    /**
     * Run the migrations.
     *
...
BEGIN
  If (TG_OP = 'INSERT') then
    ...
    IF (NOT var_exists) THEN
      ...
      EXECUTE var_sql;      
      var_sql := 'CREATE INDEX ' || var_partIndexesTable || '_part_index_value_text_pattern_ops_index on ' || var_partIndexesTable || '(part_index_value text_pattern_ops)';
      EXECUTE var_sql;
      var_sql := 'CREATE INDEX ' || var_partIndexesTable || '_part_index_value_index on ' || var_partIndexesTable || '(part_index_value)';
      EXECUTE var_sql;      
    END IF;
